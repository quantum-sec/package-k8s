output "generation" {
  ...
  value       = kubernetes_service.service.metadata.generation
}
...
output "resource_version" {
  ...
  value       = kubernetes_service.service.metadata.resource_version
}

output "self_link" {
  description = "A URL representing this service."
  value       = kubernetes_service.service.metadata.self_link
}

output "uid" {
  description = "The unique identifier for this service."
  value       = kubernetes_service.service.metadata.uid
}
